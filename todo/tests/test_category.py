...
class TestRetrieveCategory:
    ...
    def test_if_category_does_not_exists_return_404(self, retrieve_category, authenticate):
        authenticate()
...
class TestUpdateCategory:
    ...
    def test_if_category_does_not_exists_return_404(self, update_category, authenticate):
        authenticate()
...
class TestDeleteCategory:
    ...
    def test_if_category_does_not_exists_return_404(self, delete_category, authenticate):
        authenticate()
